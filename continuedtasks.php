...
background-repeat: no-repeat;">
    ...
    <div id="anasayfa">
        ...
        <br>
        <h2 style="text-align: center;">Üzerinde çalıştığın projeleri görüntülüyorsun.</h2>
        <br>
        ...
        <tr>
            ...
            <th style="width: 10%">Tahmini Süre</th>
        ...
        <?php if ($bilgilerimcek['kullanici_id'] == $kullanici_id && $bilgilerimcek['task_type'] == '2') {?>

                <tr>
            
            <td><?php echo $bilgilerimcek['task_ad'] ?></td>
            <td><?php echo $bilgilerimcek['task_teknikuzman'] ?></td>
            <td><?php echo $bilgilerimcek['task_tahminisure'] ?></td>
            ...
            <td align="center"><a href="duzenle2.php?task_id=<?php echo $bilgilerimcek['task_id'] ?>"><button>Not Düzenle</button></td></a>
            <td align="center"><a href="duzenle1.php?task_id=<?php echo $bilgilerimcek['task_id'] ?>"><button>Projeyi Bitir</button></td></a>
            <?php } ?>
