...
background-repeat: no-repeat;
    ...
    <div id="anasayfa">
        ...
        <br>
        <h2 style="text-align: center;">Henüz başlamadığın projelerini görüntülüyorsun.</h2>
        <br>
        ...
        <?php if ($bilgilerimcek['kullanici_id'] == $kullanici_id && $bilgilerimcek['task_type'] == '1') {?>
            ...
            <td align="center"><a href="duzenle.php?task_id=<?php echo $bilgilerimcek['task_id'] ?>"><button>Projeye Başla</button></td></a>
            <?php } ?>
